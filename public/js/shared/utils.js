...
function isApproved(data) {
    if (data === 0) {
        return `<span class='badge bg-primary p-2 text-uppercase'>Pending</span>`;
    } else if (data === 1) {
        return `<span class='badge bg-warning text-white p-2 text-uppercase'>Approved</span>`;
    } else {
...
function isActivated(data) {
    if (data === 0) {
        return `<span class='badge bg-primary p-2 text-uppercase'>Deactivated</span>`;
    } else {
        return `<span class='badge bg-warning p-2 text-uppercase'>Activated</span>`;
    }
}
