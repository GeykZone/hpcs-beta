                ...
                <div class="card">
                    <div class="card-header bg-primary">
                        <a class=" float-end btn btn-sm btn_green rounded me-3" href="javascript:void(0)"
                            onclick="toggle_modal('#m_barangay', '.barangay_form', ['#m_barangay_title','Add Barangay'], ['.btn_add_barangay','.btn_update_barangay'])">Add
                            Barangay +</a><br>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered barangay_dt">
                                <caption>List of Barangay <i class="fas fa-users ms-1"></i> </caption>
                                <thead>
                                    <tr>
                                        <th>Barangay</th>
                                        <th>Lat</th>
