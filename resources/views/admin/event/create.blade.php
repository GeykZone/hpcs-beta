            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-center fw-normal txt_green">Add Event <div class="i far fa-calendar ms-1"></div>
                        </h2>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('city_admin.event.store') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                <select class="select2" name="barangay_id" id="d_barangay" value="{{ old('barangay_id') }}"
                                    required>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input class="form-control" type="datetime-local" min="2021-10-01T00:00"
                                    max="2022-01-01T00:00" name="date_time_start" value="{{ old('date_time_start') }}"
                                    required>
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label">DateTime End *</label>
                                <input class="form-control" type="datetime-local" min="2021-10-01T00:00"
                                    max="2022-01-01T00:00" name="date_time_end" value="{{ old('date_time_end') }}"
                                    required>
