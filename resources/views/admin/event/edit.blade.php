                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a class="btn btn_green text-decoration-none text-white"
                                    href="{{ route('city_admin.event.index') }}"><i class="fas fa-chevron-left me-1"></i>Go
                                    Back</a>
                                <img class="img-fluid" src="{{ asset('img/event/event.svg') }}" alt="event.svg">
                            </div>
                            <div class="col-md-6">
                                <h1 class="fw-bold txt_green"> Edit Event <div class="i far fa-edit ms-1"></div>
                                </h1>
                                <br>
                                <form action="{{ route('city_admin.event.update', $event->id) }}" method="post">
                                        ...
                                        <select class="select2" name="barangay_id" id="d_barangay" required>
                                            ...
                                            @foreach ($barangays as $barangay)
                                                <option value="{{ $barangay->id }}"
                                                    @if ($event->barangay_id === $barangay->id) selected @endif> {{ $barangay->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input class="form-control" type="datetime-local" min="2022-01-01T00:00"
