                ...
                <div class="card">
                    <div class="card-header bg-primary">
                        <a class=" float-end btn btn-sm btn_green rounded me-3" href="javascript:void(0)"
                            onclick="toggle_modal('#m_family_history', '.family_history_form', ['#m_family_history_title','Add Family History'], ['.btn_add_family_history','.btn_update_family_history'])">Add
                            Family History +</a><br>
                    </div>
                    <div class="card-body">
