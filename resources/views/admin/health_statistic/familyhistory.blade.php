                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select class="form-select" name="health_issue_id"
                                    onchange="getStatisticByFamilyHistory(this)">
                                    <option value="">--Select--</option>
                                    @foreach ($family_histories_issue as $family_history)
                                        <option value="{{ $family_history->id }}" data-value='{{ $family_history->type }}'>
                                            Generate statistic for {{ $family_history->type }} by different Barangay
                                        </option>
                                    @endforeach
                                </select>
                            </div>
...
@section('script')
    ...
    <script>
        $("#statistics_nav").addClass("nav-active");
    </script>
@endsection
