                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered total_health_issue">
                                <caption>List of Total Health Issues Per barangay <i class="far fa-chart-bar ms-1"></i>
                                </caption>
                                <thead>
                                    <tr>
                                        <th>Barangay</th>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered total_family_history">
                                <caption>List of Total Family History Per barangay <i class="far fa-chart-bar ms-1"></i>
                                </caption>
                                <thead>
                                    <tr>
                                        <th>Barangay</th>
