                    ...
                    <div class="w-100">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card bg-primary">
                                    <div class="card-body d-flex and flex-column">
                                        <a href="{{ route('brgy_admin.resident.index') }}"
                                ...
                                <div class="card bg-primary">
                                    <div class="card-body d-flex and flex-column">
                                        <a href="{{ route('brgy_admin.event.index') }}"
                                ...
                                <div class="card bg-primary">
                                    <div class="card-body d-flex and flex-column">
                                        <a href="{{ route('brgy_admin.health_statistic.index') }}"
                            ...
                            <div class="col-sm-6">
                                <div class="card bg-primary">
                                    <div class="card-body d-flex and flex-column">
                                        <a href="{{ route('brgy_admin.health_profile.index') }}"
