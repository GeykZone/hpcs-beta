                ...
                <div class="card">
                    <div class="card-header bg-primary">
                        <a class=" float-end btn btn-sm btn_green rounded me-3" href="javascript:void(0)"
                            onclick="toggle_modal('#m_event', '.event_form', ['#m_event_title','Add event'], ['.btn_add_event','.btn_update_event'])">Add
                            Event +</a><br>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered event_dt py-3">
                                <caption>List of Health Program in my Barangay <i class="fas fa-laptop-medical ms-1"></i>
                                </caption>
                                <thead>
                                    <tr>
                                        <th>#</th>
