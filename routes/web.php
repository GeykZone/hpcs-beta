...
// City Admin
Route::group(['middleware' => ['auth', 'city_admin'], 'prefix' => 'city-admin', 'as' => 'city_admin.'],function() {
...
// Barangay Admin
Route::group(['middleware' => ['auth'], 'prefix' => 'barangay-admin', 'as' => 'brgy_admin.'],function() {
